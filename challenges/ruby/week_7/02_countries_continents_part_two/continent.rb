...
# one of which should be countries. This will be an attribute that is an array of country objects.
...
city_one = City.new('Melbourne')
p city_one.name


 
# Make some objects relating to each class, and assign them to the relevant classes array attribute. 
# Eg, cities would be in an array relating to the ‘cities’ attribute of a state or country object. 
# Add a continent view class that will display the details within the continents
