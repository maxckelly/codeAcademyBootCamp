...
objectOne = {
  ...
  hobbie: 'Surfing',
  speak: function() {
    return `${this.name} likes ${this.hobbie}`
  }
};

// console.log(objectOne);
// console.log(objectOne.speak());
...
console.log(objectTwo.keyOne());
console.log(objectTwo.keyTwo());
console.log(objectTwo.keyThree());
...
console.log(objectFunction().job());
